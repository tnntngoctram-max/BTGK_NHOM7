...
public abstract class BTGK_NHOM7WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static BTGK_NHOM7WebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(BTGK_NHOM7WebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<BTGK_NHOM7DbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<BTGK_NHOM7DbContext, Task> action)
    {
        using (var context = IocManager.Resolve<BTGK_NHOM7DbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<BTGK_NHOM7DbContext, Task<T>> func)
    {
        T result;
