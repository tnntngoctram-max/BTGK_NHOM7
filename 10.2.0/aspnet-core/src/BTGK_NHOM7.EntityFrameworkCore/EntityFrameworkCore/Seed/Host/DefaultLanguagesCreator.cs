...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = BTGK_NHOM7Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(BTGK_NHOM7DbContext context)
    {
        _context = context;
    }
