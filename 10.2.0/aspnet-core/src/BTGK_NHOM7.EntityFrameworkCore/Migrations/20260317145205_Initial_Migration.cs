...
namespace BTGK_NHOM7.Migrations
{
    /// <inheritdoc />
    public partial class Initial_Migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToeicExams", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToeicParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToeicParts_ToeicExams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToeicPassages_ToeicParts_PartId",
                        column: x => x.PartId,
                        principalTable: "ToeicParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToeicQuestions_ToeicParts_PartId",
                        column: x => x.PartId,
                        principalTable: "ToeicParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToeicParts_ExamId",
                table: "ToeicParts",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ToeicPassages_PartId",
                table: "ToeicPassages",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_ToeicQuestions_PartId",
